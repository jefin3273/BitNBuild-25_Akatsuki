...
const AddProject: React.FC = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      description: "Copywriting, articles, documentation",
    },
    {
      value: "tutoring",
      label: "Tutoring & Teaching",
      description: "Academic help, skill training",
    },
  ...
  if (currentUserProfile.role !== "client") {
    return (
      <div className="min-h-screen pt-16 bg-background text-foreground flex items-center justify-center">
        <div className="text-center max-w-md">
          <Shield className="w-16 h-16 text-orange-500 mx-auto mb-4" />
          <div className="text-xl mb-2">Access Restricted</div>
          <div className="text-sm text-muted-foreground mb-4">
            Only clients can post projects. Your account is registered as a{" "}
            <strong>{currentUserProfile.role}</strong>.
          </div>
          <div className="text-xs text-muted-foreground mb-6">
            If you need to change your account type, please contact support or
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-green-700 text-sm">
                  Your project is now live and freelancers can start bidding.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-card rounded-2xl shadow-sm border border-border overflow-hidden">
          <div className="p-8 space-y-6">
              ...
              formData.budget_min < formData.budget_max && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <p className="text-blue-800 text-sm">
                    ...
                    {formData.budget_min.toLocaleString()} - $
                    {formData.budget_max.toLocaleString()}
                    <span className="text-blue-600 ml-2">
                      (stored as {(formData.budget_min * 100).toLocaleString()}{" "}
                      - {(formData.budget_max * 100).toLocaleString()} cents)
                    </span>
                  </p>
                </div>
              )}
            ...
            <div>
              ...
              {formData.deadline && (
                <p className="text-muted-foreground text-xs mt-1">
                  Deadline will be set to end of day:{" "}
                  {new Date(formData.deadline + "T23:59:59").toLocaleDateString(
                    "en-US",
                    {
                      weekday: "long",
                      year: "numeric",
        ...
        <div className="mt-8 bg-blue-50 rounded-xl p-6 border border-blue-200">
          ...
          <ul className="space-y-2 text-blue-800 text-sm">
            ...
            <li>
              • Include any relevant files, mockups, or reference materials
            </li>
