...
export function Hero() {
  return (
    <header className="w-full border-b bg-background" aria-labelledby="about-hero-heading">
      <div className="mx-auto max-w-7xl px-8 py-20 sm:py-16 md:py-20">
        <h1
          id="about-hero-heading"
          className="text-balance text-3xl font-semibold tracking-tight pt-9 px-4 text-foreground sm:text-4xl md:text-5xl"
        >
          Empowering Students, Connecting Talent.
        </h1>
        <p className="mt-4 max-w-2xl px-4 text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
